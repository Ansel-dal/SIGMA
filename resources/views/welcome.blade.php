                            ...
                            <div class="d-flex justify-content-between align-items-baseline">
                                ...
                                <div class="dropdown mb-2">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        <a class="dropdown-item d-flex align-items-center" href="dashboard-one.html#"><i
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex flex-column">
                        <a href="dashboard-one.html#" class="d-flex align-items-center border-bottom pb-3">
                            <div class="mr-3">
                        ...
                        <a href="dashboard-one.html#" class="d-flex align-items-center border-bottom py-3">
                            <div class="mr-3">
